...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 8:
        ...
        print("\t" "python3 " + sys.argv[
            0] + " <SIMULATION_TIME> <N_CASHIERS> <MEAN_TIME_TO_DISPATCH_CLIENT> <MEAN_TIME_BETWEEN_NEW_CLIENTS> "
    ...
    print(f'\tMean time between new clients: {mean_generator} seconds (standard deviation of {stddev_employees})')
    ...
    rt_manager.add_output_handler('csv', file='rt_simulation_csv_output_handler.csv')
